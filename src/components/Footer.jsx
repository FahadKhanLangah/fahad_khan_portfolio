...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-b from-gray-900 to-gray-800 text-white pt-4 sm:pt-6 pb-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-16">
          ...
          >
            <h3 className="text-xl font-semibold mb-4 border-l-4 border-blue-500 pl-3">Quick Links</h3>
            <ul className="space-y-3">
              {['Home', 'Skills', 'Services', 'Projects', 'Contact'].map((item, index) => (
                <li key={index}>
                  <a
                    href={`#${item.toLowerCase()}`}
                    className="opacity-80 hover:opacity-100 hover:text-blue-400 transition-all duration-300"
                  >
                    {item}
                  </a>
                </li>
          ...
          >
            <h3 className="text-xl font-semibold mb-4 border-l-4 border-blue-500 pl-3">Contact Me</h3>
