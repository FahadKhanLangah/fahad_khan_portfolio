  ...
  return (
    <div id="work" className="my-5 mx-2">
      ...
      <div className="flex justify-center sm:flex-row flex-col gap-10 sm:gap-6 items-center">
        <Link to={'/project-detail/ecommerce'}><div className='relative group hover:border-blue-600 cursor-pointer h-40 w-60 bg-slate-100 shadow-lg border-2 flex flex-col items-center rounded-xl justify-center overflow-hidden'>
        ...
        <Link to={'/project-detail/ecommerce'}>
        ...
        <AnchorLink href='#home'><div className='relative group hover:border-blue-600 cursor-pointer h-40 w-60 bg-slate-100 shadow-lg border-2 flex flex-col items-center rounded-xl justify-center overflow-hidden'>
